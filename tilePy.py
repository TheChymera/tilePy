...
sequence = pd.DataFrame.from_csv('/home/chymera/src/pystim/sequences/faceRT_blocksize4.csv')
...
for idx, trial in sequence.iterrows():
    ...
    bg.paste(top_img,(565,89))
    bg.paste(left_img,(269,385))
    bg.paste(right_img,(861,385))
    bg.save(path.splitext(output_dir+trial['top face'])[0]+'_composite'+'.jpg')
